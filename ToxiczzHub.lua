...
local Window = OrionLib:MakeWindow({Name = "Toxiczz Hub", HidePremium = false, IntroText = "Toxiczz Library", SaveConfig = true, ConfigFolder = "Toxiczz Hub"})
----------Tab-----------------------
